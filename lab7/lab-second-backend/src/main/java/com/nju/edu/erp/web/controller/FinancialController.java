...
public class FinancialController {
    ...
    @GetMapping(value = "/receipt-sheet-by-id")
     ...
     */
    @Authorized(roles = {Role.GM, Role.FINANCIAL_STAFF, Role.ADMIN})
    @GetMapping(value = "/payment-order-by-id")
     ...
     */
    @Authorized(roles = {Role.GM, Role.FINANCIAL_STAFF, Role.ADMIN})
    @GetMapping(value = "/payroll-by-id")
    ...
    @Authorized (roles = {Role.GM, Role.SALE_MANAGER, Role.ADMIN})
