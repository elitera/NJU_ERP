...
//        return saleReturnsSheetDao.getSalesSheetsByTime(beginDate, endDate);
//    }
//
//    @Override
//    public List<SalesDetailsSheetVO> getSalesSheetsByName(String name) {
//        return saleReturnsSheetDao.getSalesSheetsByName(name);
//    }
//
//    @Override
//    public List<SalesDetailsSheetVO> getSalesSheetsByOperator(String operator) {
//        return saleReturnsSheetDao.getSalesSheetsByOperator(operator);
//    }
//
//    @Override
//    public List<SalesDetailsSheetVO> getSalesSheetsByCustomer(String customer) {
//        return saleReturnsSheetDao.getSalesSheetsByCustomer(customer);
//    }

    @Override
    public List<String> findSheetIdByOperator(String operator) {
        return saleReturnsSheetDao.findSheetIdByOperator(operator);
    }

    @Override
    public List<String> findSheetIdByTime(Date beginDate, Date endDate) {
        return saleReturnsSheetDao.findSheetIdByTime(beginDate, endDate);
    }

    @Override
    public List<SalesDetailsSheetVO> findSaleSheetsBySomeConditions(SaleDetailsSheetSearchCriteriaPO searchCriteria) {
        return saleReturnsSheetDao.findSaleSheetsBySomeConditions(searchCriteria);
    }

    @Override
    public List<String> findSheetIdBySomeConditions(BusinessHistorySheetSearchCriteriaPO searchCriteriaPO) {
        return saleReturnsSheetDao.findSheetIdBySomeConditions(searchCriteriaPO);
    }

    @Override
    public SaleReturnsSheetVO findSheetIdById(String id) {
        SaleReturnsSheetVO res = new SaleReturnsSheetVO();
        if (id == null) {
            return null;
        }
        SaleReturnsSheetPO saleReturnsSheetPO = saleReturnsSheetDao.findSheetById(id);
        BeanUtils.copyProperties(saleReturnsSheetPO, res);
        List<SaleReturnsSheetContentPO> contentPOS = saleReturnsSheetDao.findContentBySaleReturnsSheetId(saleReturnsSheetPO.getId());
        List<SaleReturnsSheetContentVO> contentVOS = new ArrayList<>();
        for (SaleReturnsSheetContentPO p : contentPOS) {
            SaleReturnsSheetContentVO v = new SaleReturnsSheetContentVO();
            BeanUtils.copyProperties(p, v);
            contentVOS.add(v);
        }
        res.setSaleReturnsSheetContent(contentVOS);
        return res;
