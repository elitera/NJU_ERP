...
<script>
import InventoryPresentCard from "@/views/inventory/components/InventoryPresentCard";
import { warehouseOutput, warehouseOutputPre } from "@/network/warehouse";
import InventoryPresent from "@/views/inventory/InventoryPresent";
...
export default {
  ...
  methods: {
    handleSubmit(submitInfo) {
      console.log("inventoryPresent submitInfo", submitInfo); //打印 子组件传递的值
