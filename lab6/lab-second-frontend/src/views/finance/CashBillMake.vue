<template>
  <Layout>
    ...
    <el-form :model="form" ref="form" label-width="100px" class="paymentBill">
      ...
      <el-form-item label="条目清单:" prop="itemList">
        <el-form :model="form" ref="itemList" label-width="80px" class="paymentBill">
          <el-row></el-row>
          <el-form-item label="条目名" prop="name">
            <el-col :span="6">
              <el-input v-model="form.termSheetList[0].name"></el-input>
            </el-col>
          </el-form-item>
          <el-form-item label="金额" prop="amount" class="listInput">
            <el-col :span="6">
              <el-input v-model="form.termSheetList[0].money"></el-input>
            </el-col>
          </el-form-item>
          <el-form-item label="备注" prop="remarks" class="listInput">
            <el-col :span="12">
              <el-input v-model="form.termSheetList[0].remark"></el-input>
            </el-col>
          </el-form-item>
        </el-form>
      </el-form-item>
      <el-form-item label="总额" prop="totalSum">
        <el-col :span="6">
...
import { cashBillMake } from '../../network/finance';
...
export default {
  ...
  methods: {
    ...
    summit() {
      ...
      cashBillMake(this.form).then(res => {
        if (res.code === '00000') {
          alert('提交成功');
        }
        else {
